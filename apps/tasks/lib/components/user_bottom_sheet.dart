...
class _UserBottomSheetState extends State<UserBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ThemeModel>(builder: (BuildContext context, ThemeModel themeNotifier, __){
      return BottomSheet(
                                 ...
                                 child:  DropdownButton(
                                   ...
                                   items: items.map((String value) {
                                     return DropdownMenuItem(
                                         ...
                                         child: Row(
                                           children: [
                                             Text(context.localization!.station, style: const TextStyle(color: Colors.grey),),
                                             Expanded(
                                                 child: Align(
